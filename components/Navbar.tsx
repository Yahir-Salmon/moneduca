    ...
    <>
      <style>{`
        ...
        .nav-user-name {
          ...
          color: #6B4520; padding: 8px 14px; background: rgba(252,230,139,0.4);
          border-radius: 100px;
        }
        .nav-logout {
      ...
      <div className={`mobile-menu ${open ? 'open' : ''}`}>
        ...
        {session ? (
          <>
            ...
            <button onClick={() => { handleLogout(); setOpen(false) }} className="btn btn-outline" style={{ marginTop: 16, width: '100%', justifyContent: 'center' }}>
              Cerrar sesión
            </button>
          </>
        ) : (
